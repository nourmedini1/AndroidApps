...
public class SecondOrder extends AppCompatActivity {
    TextView titlesecode;
    MaterialButton homesecode,backsecode,submitsecode;
    MultiAutoCompleteTextView coef1EditText,variableEditText,coef2EditText,
            coef3EditText,smEditText,constantEditText,ic1EditText,ic2EditText,ic3EditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        titlesecode = findViewById(R.id.titlefsecode);
        homesecode = findViewById(R.id.homesecode);
        backsecode = findViewById(R.id.backsecode);
        submitsecode = findViewById(R.id.submitsecode);
        variableEditText = findViewById(R.id.varsecode);
        coef1EditText = findViewById(R.id.coef1secode);
        coef2EditText = findViewById(R.id.coef2secode);
        coef3EditText = findViewById(R.id.coef3secode);
        constantEditText = findViewById(R.id.constsecode);
        smEditText = findViewById(R.id.smsecode);
        ic1EditText = findViewById(R.id.ic1secode);
        ic2EditText = findViewById(R.id.ic2secode);
        ic3EditText = findViewById(R.id.ic3secode);
        homesecode.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        backsecode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        submitsecode.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(coef1EditText.getText().toString().trim().equals("")){
                    ...
                    String coef3 = coef3EditText.getText().toString().trim().replaceAll("\\s","");;
                    ...
                    try {
                        parametres = jsonHandlerOde.secondOrderOdeJSON(coef1,coef2,coef3,constant,variable,sm,ic1,ic2,ic3);
                    ...
                    try {
                        result = ode.callAttr("second_order_diff_eq",parametres).toString();
