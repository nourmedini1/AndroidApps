...
public class DoublePrimitive extends AppCompatActivity {
    TextView titledoubleprim;
    MaterialButton homedoubleprim,backdoubleprim,submitdoubleprim;
    MultiAutoCompleteTextView functionEditText,variableEditText;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_double_primitive);
        titledoubleprim = findViewById(R.id.titledoubleprim);
        homedoubleprim = findViewById(R.id.homesdoubleprim);
        backdoubleprim = findViewById(R.id.backdoubleprim);
        submitdoubleprim = findViewById(R.id.submitdoubleprim);
        variableEditText = findViewById(R.id.variablesdoubleprim);
        functionEditText = findViewById(R.id.functionsdoubleprim);
        homedoubleprim.setOnClickListener(new View.OnClickListener() {
            @Override
        ...
        backdoubleprim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
        ...
        submitdoubleprim.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                ...
                if(functionEditText.getText().toString().trim().equals("")){
                    ...
                    try {
                        parametres = jsonHandlerIntegral.doublePrimitiveJSON(function,variables);
                    ...
                    try {
                        result = integral.callAttr("double_primitive",parametres).toString();
